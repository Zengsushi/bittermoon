...
export default {
        ...
        methods:{
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        instance.get('/moveout/moveoutSearch',{params:_this.ruleForm} , {
                            headers: {
            ...
            page(currentPage){
                ...
                if(_this.ruleForm.value == ''){
                    instance.get('/moveout/moveoutList/'+currentPage+'/'+_this.pageSize , {
                            headers: {
                                "Authorization":  localStorage.token
                            }
                        }).then(function (resp) {
        ...
        created() {
            const _this = this
            instance.get('/moveout/moveoutList/1/'+_this.pageSize , {
                            headers: {
                                "Authorization":  localStorage.token
                            }
                        }).then(function (resp) {
