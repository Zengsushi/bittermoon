...
<script>
    ...
    export default {
        ...
        methods:{
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        instance.get('/building/search',{params:_this.ruleForm} , {
                            headers: {
            ...
            page(currentPage){
                ...
                if(_this.ruleForm.value == ''){
                    instance.get('/building/list/'+currentPage+'/'+_this.pageSize , {
                            headers: {
                                "Authorization":  localStorage.token
                            }
                        }).then(function (resp) {
            ...
            del(row) {
                ...
                this.$confirm('确认删除【'+row.name+'】吗？', '提示', {
                    ...
                    instance.delete('/building/deleteById/'+row.id , {
                            headers: {
                                "Authorization":  localStorage.token
                            }
                        }).then(function (resp) {
        ...
        created() {
            const _this = this
            instance.get('/building/list/1/'+_this.pageSize , {
                            headers: {
                                "Authorization":  localStorage.token
                            }
                        }).then(function (resp) {
