...
<script>
    ...
    export default {
        ...
        methods: {
            buildingChange(){
                const _this = this
                instance.get('/absent/findDormitoryByBuildingId/'+_this.ruleForm.buildingId , {
                            headers: {
            ...
            dormitoryChange(){
                const _this = this
                instance.get('/absent/findStudentByDormitoryId/'+_this.ruleForm.dormitoryId , {
                            headers: {
                                "Authorization":  localStorage.token
                            }
                        }).then(function (resp) {
            ...
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        instance.post('/absent/save',_this.ruleForm, {
                            headers: {
                                "Authorization":  localStorage.token
                            }
                        }).then(function (resp) {
        ...
        created() {
            const _this = this
            instance.get('/absent/buildingList' , {
                            headers: {
                                "Authorization":  localStorage.token
                            }
                        }).then(function (resp) {
