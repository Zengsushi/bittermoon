...
export default {
        ...
        methods:{
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        instance.get('/student/search',{params:_this.ruleForm}, {
                            headers: {
            ...
            page(currentPage){
                ...
                if(_this.ruleForm.value == ''){
                    instance.get('/student/list/'+currentPage+'/'+_this.pageSize,{
                            headers: {
                                "Authorization":  localStorage.token
                            }
                        }).then(function (resp) {
          ...
          headers: {
            ...
            del(row) {
                ...
                this.$confirm('确认删除【'+row.name+'】吗？', '提示', {
                    ...
                    instance.delete('/student/deleteById/'+row.id , {
                            headers: {
                                "Authorization":  localStorage.token
                            }
                        }).then(function (resp) {
        ...
        created() {
            const _this = this
            instance.get('/student/list/1/'+_this.pageSize , {
                            headers: {
                                "Authorization":  localStorage.token
                            }
                        }).then(function (resp) {
