<template>
    <div style="margin-top: 60px;margin-left:80px;border: 0px solid red;" >
        <el-form style="margin-left: -40px" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <div style="border: 0px solid red;width: 400px;height: 60px;position: relative;top: -64px;left: 270px; margin-top: 30px;">
...
<script>
    ...
    export default {
        ...
        methods:{
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        instance.get('/absent/search',{params:_this.ruleForm}, {
                            headers: {
            ...
            page(currentPage){
                ...
                if(_this.ruleForm.value == ''){
                    instance.get('/absent/list/'+currentPage+'/'+_this.pageSize , {
                            headers: {
                                "Authorization":  localStorage.token
                            }
                        }).then(function (resp) {
        ...
        created() {
            const _this = this
            instance.get('/absent/list/1/'+_this.pageSize,{
                            headers: {
                                "Authorization":  localStorage.token
                            }
                        }).then(function (resp) {
